...
MODEL_DIR= "models" # Carpeta para guardar el modelo entrenado
MODEL_PATH =os.path.join(MODEL_DIR,"model.pkl") # Ruta del modelo entrenado
VECTORIZER_PATH=os.path.join(MODEL_DIR,"vectorizer.pkl") # Ruta del vectorizador
ANSWERS_PATH=os.path.join(MODEL_DIR,"answers.pkl") # Ruta de las respuestas únicas
